...
public class DragonWeapon extends SwordItem implements ConfigurableAttributes {
    ...
    public DragonWeapon(ToolMaterial material, Settings settings) {
        this(material, 1, 2.4F, settings);
    }

    public DragonWeapon(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
