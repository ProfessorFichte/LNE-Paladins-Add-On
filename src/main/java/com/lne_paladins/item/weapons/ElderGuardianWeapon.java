...
public class ElderGuardianWeapon extends SwordItem implements ConfigurableAttributes {
    ...
    public ElderGuardianWeapon(ToolMaterial material, Settings settings) {
        this(material, 1, 2.4F, settings);
    }

    public ElderGuardianWeapon(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
